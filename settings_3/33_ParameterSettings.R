...
n_sim = 1000
outfiles_prefix = "33_Sim_linear_eigenfunc_noMVMRcor"
outfiles_dir = "results_3"
save_data_perSim = F
do_plotting = F
n_cores = 10
...
X_useAs2ndFunction = "X_func3" # possible functions X_func1, X_func2, X_func3
...
#############################
AssocModel = "eigenfunc"      # possible models: meanSD, eigenfunc, linMixed, gamlss
